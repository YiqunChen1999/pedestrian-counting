...
# dataset settings
dataset_type = 'DHDTrafficDataset'
data_root = '/data1/chenyiqun/models/pedestrian-counting/data/'
img_norm_cfg = dict(
...
evaluation = dict(interval=10000, metric=['bbox', 'miss_rate'], proposal_nums=(1, 10, 100))
